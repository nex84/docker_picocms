...
RUN apt-get update && apt-get -y install apt-transport-https wget vim unzip php5-zip php5-gd
...
ADD search.md /tmp/pico/content/search.md
ADD search.twig /tmp/pico/theme/default/search.twig
